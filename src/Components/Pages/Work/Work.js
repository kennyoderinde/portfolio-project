...
const WorkPage = () => {
  return (
    <div id="workSection" className=' relative bg-[#020c1b] z-20  sm:-space-y-20 left-52 sm:left-40 -top-52 sm:-top-10 sm:p-4 sm:-mt-64 w-80 sm:w-full ' style={{ height: '220%'}}>
      <Citrone />
      <CacClone />
      <ResumeWise />
      <HomezPage />
