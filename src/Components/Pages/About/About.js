...
const About = () => {
  ...
  return (
    <React.Fragment>
        ...
        <div id="aboutSection" className=' relative bg-[#041e3e] left-20 p-4 -mt-24 ' style={{width: "95%", height: '100%'}}>
          <div className='flex ml-10  -space-x-80'>
            ...
            <div className='p-12 ml-14 mt-20 '>
              ...
              <div className='grid space-y-10 '>
                ...
                <div className=' mt-6'  style={{ width: '50%', height: '28%'}}>
                  <p className=' font-montserrat font-medium text-base text-gray-400 '
                ...
                <div className='-mt-10'  style={{ width: '56%', height: '28%'}}>
                  <p className='  font-montserrat font-medium text-base text-gray-400 whitespace-normal'>
