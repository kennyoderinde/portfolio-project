...
const About = () => {
  ...
  return (
    <React.Fragment>
        <div id="aboutSection" className=' z-20 relative flex-auto bg-[#020c1b] left-38 sm:left-12 p-10 sm:p-4 -top-40 w-80 sm:w-full ' style={{ height: '150%'}}>
            <div className=' relative p-12 -ml-14 sm:ml-28 mt-20 '>
              ...
              <div className='grid space-y-6 sm:space-y-8 sm:w-60 '>
                ...
                <div className=' mt-6 w-0.5rem h-0.28rem sm:w-0.5rem'  style={{ }}>
                  <p className=' font-montserrat font-normal  text-xs sm:text-base text-gray-400 tracking-wide		'
                ...
                <div className='-mt-10 w-0.5rem h-0.28rem sm:w-0.5rem'  style={{ }}>
                  <p className='  font-montserrat font-normal text-xs sm:text-base text-gray-400 whitespace-normal tracking-wide	'>
          ...
          <div className='flex items-center sm:ml-36 sm:space-x-14 space-x-20 -mt-4 -ml-32 flex-col sm:flex sm:flex-row '>
