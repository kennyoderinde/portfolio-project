  ...
  return (
    <React.Fragment>
        <div id="aboutSection" className=' z-20 relative flex-auto bg-[#020c1b] left-38 sm:left-20 p-10 sm:p-4 sm:-top-20 -top-44 w-80 sm:w-full ' style={{ height: '150%'}}>
          ...
          <div className='flex items-center sm:ml-36 sm:space-x-24 space-x-20 -mt-4 -ml-72 flex-col sm:flex sm:flex-row '>
            ...
            <div className="z-40 sm:relative absolute -left-10 top-80 sm:-top-96 sm:left-96 hover:ml-8 hover:bg-green-500 hover:opacity-70 border-2 border-green-500 rounded-lg  sm:w-18 sm:h-18">
                <img src={MyPics} alt="" className="absolute hover:bg-green-500 hover:ml-8 hover:mt-8 top-96 left-40 sm:top-0 sm:left-0 transition-all duration-1000 delay-500 rounded-lg h-auto w-40 sm:w-full max-w-xs sm:max-w-full sm:h-auto" style={{  }} />
            </div>
