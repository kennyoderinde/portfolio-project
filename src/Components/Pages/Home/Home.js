...
const Home = () => {
  return (
    <React.Fragment>                        
      <div id="homeSection" className=' flex-auto bg-[#020c1b] z-20 ml-28  sm:ml-20 sm:-mt-20  p-4 w-80 sm:w-full ' style={{ height: '150%'}}>
        <div className=' ml-12 sm:ml-20 mt-28 sm:mt-28  px-4 md:flex-row'>
          ...
          <p className=' w-44 sm:w-64 px-4 py-4 sm:px-7  sm:py-5 rounded-lg mb-36 sm:mb-40 border border-green-400 mt-8 text-green-400 text-xs sm:text-base font-roboto font-normal whitespace-nowrap '><a href= ''>Check out my projects</a></p>
