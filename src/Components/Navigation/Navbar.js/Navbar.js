...
const Navbar = () => {
  ...
  return (
    <header className=" fixed top-0 z-50 flex items-center justify-between flex-wrap backdrop-blur-lg  bg-[#020c1b] p-4 shadow-md sm:space-x-44 w-80 " style={{ }} >
...
//   return (
//     <header className=" sticky top-0 z-50 flex items-center justify-between flex-wrap backdrop-blur-lg  bg-[#020c1b] p-4 shadow-md space-x-72 " style={{ }} >
...
//       </div>
//       <div className="w-full -mt-8 block flex-grow lg:flex lg:items-center lg:w-auto">
//         <div className="text-sm flex flex-wrap lg:flex-grow justify-center space-x-6 ml-80">
